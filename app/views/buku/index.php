...
<div class="content-wrapper">
    ...
    <h3 class="card-title"><?= $data['title']; ?></h3>
    <div class="btn-group float-right">
        <a href="<?= base_url; ?>/buku/tambah" class="btn float-right btn-xs btn-primary">Tambah Buku</a>
        <a href="<?= base_url; ?>/buku/laporan" class="btn float-right btn-xs btn-info">Laporan Buku</a>
        <a href="<?= base_url; ?>/buku/lihatLaporan" class="btn float-right btn-xs btn-warning">Lihat Laporan Buku</a>
    </div>
</div>
            <!-- /.card-body -->
